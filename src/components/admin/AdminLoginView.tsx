    ...
    >
      ...
      >
        ...
        <div className="flex gap-2 w-full">
          <button type="button" onClick={onBack} className="flex-1 p-3 text-slate-500 font-medium">
            Voltar
          </button>
          <button type="submit" className="flex-1 p-3 bg-emerald-700 text-white rounded-xl font-bold">
            Entrar
          </button>
        </div>
      </form>
